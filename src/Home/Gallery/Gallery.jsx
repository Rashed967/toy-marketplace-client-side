...
const Gallery = () => {
    ...
    return (
        <div>
            <h3 data-aos="fade-zoom-in" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600" className='text-center text-3xl font-semibold mb-4 text-yellow-400 underline'>Gallery section </h3>
