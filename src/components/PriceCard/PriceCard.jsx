...
const PriceCard = () => {
    ...
    return (
        <>
        <div className='bg-success py-12'>
        <h2 className='text-center font-semibold underline text-3xl p-3 text-black my-10'>Our prices</h2>
        <div className="w-full md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6 mx-auto mb-24">
